...
import corp.airbus.helicopters.efactory.commons.core.config.i18n.ExposedResourceBundleMessageSource;
...
public class I18nController {
	...
	/** The resources. */
	private Map<String, ExposedResourceBundleMessageSource> resources = new HashMap<String, ExposedResourceBundleMessageSource>();
